...
<header>
    <nav class="navbar fixed-top navbar-expand-md  navbar-dark bg-dark ">
        <div class="logo">
            <div class="icon-accueil"><a href="{{route('shop_home')}}"><img src="{{asset('img/icon/logo-menu.png')}}" alt="Rap"></a>
            </div>
        </div>
...
<div class="plus-haut">
    <a href="#top" title="Haut de page" class="scrollup" >
        <img src="{{asset('img/icon/icon_top.png')}}" alt="Le meilleur de la Musique"/>
    </a>
</div>
        ...
        <div class="row pb-3">
            ...
            <div class="col-md-12">
                ...
                <div class="mb-5 flex-center">
                    ...
                    <!-- Facebook -->
                    <a class="facebook">
                        <a href="https://www.facebook.com/M223music" target="_blank"><img src="{{asset('img/icon/facebook.png')}}" height="37px" width="37px" frameborder="0" alt="Musique Malienne"/></a>
                    </a>
                    <!-- Twitter -->
                    <a class="Twitter">
                        <a href="https://twitter.com/m223music" target="_blank"><img src="{{asset('img/icon/twitter.png')}}" height="35px" width="35px" frameborder="0" alt="Musique Française"/></a>
                ...
                <!--Linkedin -->
                    <a class="li-ic">
                        <a href="https://www.linkedin.com/in/m-music-b610961a9/" target="_blank"><img src="{{asset('img/icon/linkedin.png')}}" height="30px" width="30px" frameborder="0" alt="Musique Americaine"/></a>
                    </a>
                ...
                <!--Youtube-->
                    <a class="youtube">
                        <a href="https://www.youtube.com/channel/UCsHds9fFTG0tz4p9LprUiGA" target="_blank"><img src="{{asset('img/icon/youtube.png')}}" height="33px" width="33px" frameborder="0" alt="Musique Congolaise"/></a>
                    </a>


                    <!--Instagram-->
                    <a class="instagram">
                        <a href="https://www.instagram.com/m223music/" target="_blank"><img src="{{asset('img/icon/instagram.png')}}" height="36px" width="36px" frameborder="0" alt="Musique Sénégalaise"/></a>
                    </a>
                </div>
            </div>

    ...
    <nav class="navbar fixed-top navbar-expand-md  navbar-dark bg-dark ">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                ...
                @csrf
                <input value="{{request()->input('query')}}" class="form-control mr-sm-2" type="text" placeholder="Recherche" aria-label="Search" name="search">
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="{{asset('images/maitre-gims-dadju.jpg')}}" alt="First Slide">
...
{{--                            </div>--}}
                        ...
                        <div class="carousel-item">
                            <img src="{{asset('images/booba-font-ecran.jpg')}}"  alt="Second Slide">
{{--                            <div class="carousel-caption">--}}
{{--                                <h2>Meilleur artiste du mois</h2>--}}
{{--                                <h5>Je remercie tous mes fans</h5>--}}
{{--                            </div>--}}
                        ...
                        <div class="carousel-item ">
                            <img src="{{asset('images/mhd-font-ecran.jpg')}}"  alt="Mali Musique" >
